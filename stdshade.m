function [lineOut, fillOut] = stdshade(amatrix,alpha,acolor,linecolor,F,smth)
...
astd = stderr(amatrix); % MY OWN PERSONAL STDERR FUNCTION
...
hold on;
lineOut = plot(F,amean, 'color', linecolor,'linewidth',1.5); %% change color or linewidth to adjust mean line
